...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return queryInterface
      .addColumn('Notes', 'lastchangeuserId', {
        type: Sequelize.UUID
      })
      .then(function () {
      ...
      .catch(function (error) {
        if (
          error.message ===
            'column "lastchangeuserId" of relation "Notes" already exists' ||
  ...
  down: function (queryInterface, Sequelize) {
    return queryInterface.removeColumn('Notes', 'lastchangeAt').then(function () {
