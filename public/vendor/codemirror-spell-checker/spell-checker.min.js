  ...
  if (
    ...
    for (var a = 0, s = this.compoundRules.length; s > a; a++) {
      for (var h = this.compoundRules[a], c = '', l = 0, u = h.length; u > l; l++) {
        var p = h[l]
        c +=
          p in this.compoundRuleCodes ? '(' + this.compoundRuleCodes[p].join('|') + ')' : p
      }
...
Typo.prototype = {
  ...
  _readFile: function (e, t) {
    ...
    return (
      r.open('GET', e, !1),
      r.overrideMimeType && r.overrideMimeType('text/plain; charset=' + t),
      r.send(null),
      r.responseText
    )
  },
  _parseAFF: function (e) {
    ...
    for (var r = e.split('\n'), n = 0, i = r.length; i > n; n++) {
      ...
      if ('PFX' == o || 'SFX' == o) {
        for (
          var l = s[1], u = s[2], h = parseInt(s[3], 10), c = [], p = n + 1, f = n + 1 + h;
          f > p;
          p++
        ) {
          var a = r[p],
          ...
          var y = this.parseRuleCodes(g[1]),
            ...
            C = {}
          ;(C.add = m),
            y.length > 0 && (C.continuationClasses = y),
            '.' !== _ && (C.match = RegExp('SFX' === o ? _ + '$' : '^' + _)),
            '0' != v && (C.remove = 'SFX' === o ? RegExp(v + '$') : v),
            c.push(C)
        }
  ...
  suggest: function (e, t) {
    ...
    function i(e) {
      ...
      for (
        var a = r([e]), s = r(a), o = n(a).concat(n(s)), l = {}, h = 0, c = o.length;
        c > h;
        h++
      )
...
CodeMirror.defineMode('spell-checker', function (e) {
  if (!aff_loading) {
    ...
    t.open('GET', serverurl + '/vendor/codemirror-spell-checker/en_US.aff', !0),
      (t.onload = function () {
        4 === t.readyState &&
          200 === t.status &&
          ((aff_data = t.responseText),
          num_loaded++,
          2 == num_loaded &&
            (typo = new Typo('en_US', aff_data, dic_data, { platform: 'any' })))
      }),
      t.send(null)
  }
  if (!dic_loading) {
    dic_loading = !0
    var r = new XMLHttpRequest()
    r.open('GET', serverurl + '/vendor/codemirror-spell-checker/en_US.dic', !0),
      (r.onload = function () {
        4 === r.readyState &&
          200 === r.status &&
          ((dic_data = r.responseText),
          num_loaded++,
          2 == num_loaded &&
            (typo = new Typo('en_US', aff_data, dic_data, { platform: 'any' })))
      }),
