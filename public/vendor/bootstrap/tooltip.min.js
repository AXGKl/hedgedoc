  ...
  +(function (t) {
    ...
    ;(i.VERSION = '3.3.7'),
      ...
      (i.prototype.enter = function (e) {
        var i =
          e instanceof this.constructor ? e : t(e.currentTarget).data('bs.' + this.type)
        return (
          i ||
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (l) {
            ...
            ;(a =
              'bottom' == a && h.bottom + f > d.bottom
                ? 'top'
                : 'top' == a && h.top - f < d.top
                  ? 'bottom'
                  : 'right' == a && h.right + u > d.width
                    ? 'left'
                    : 'left' == a && h.left - u < d.left
                      ? 'right'
                      : a),
          ...
          t.support.transition && this.$tip.hasClass('fade')
            ? s.one('bsTransitionEnd', y).emulateTransitionEnd(i.TRANSITION_DURATION)
            : y()
        }
      }),
      ...
      (i.prototype.getPosition = function (e) {
        ...
        var s = window.SVGElement && i instanceof window.SVGElement,
          ...
          p = o ? { width: t(window).width(), height: t(window).height() } : null
        return t.extend({}, n, a, p, r)
      }),
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        ...
        if (/right|left/.test(t)) {
          ...
          a < r.top
            ? (n.top = r.top - a)
            : p > r.top + r.height && (n.top = r.top + r.height - p)
        } else {
          var l = e.left - s,
            h = e.left + s + i
          l < r.left
